...
public class ConjunctionMatrixImpl implements ConjunctionMatrix {
	
	private Matrix matrixA;
	private Matrix matrixB;
	
	public ConjunctionMatrixImpl(Matrix matrixA, Matrix matrixB) {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + "conjunctionMatrix".hashCode();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ConjunctionMatrixImpl other = (ConjunctionMatrixImpl) obj;
		if (matrixA == null) {
