...
public class GPHolder implements Serializable{
	...
	private List<MyEdge> resultSchema;				//The list of nodes required in the return statement
	...
	public GPHolder(GraphPattern gp, List<Pair<MyNode, MyNode>> mexList, Map<String, MyNode> actMap){
		...
		this.actMap = actMap;
		resultSchema = new ArrayList<MyEdge>();
	}
	 ...
	 */
	public void setResultSchema(List<MyEdge> edges){
		this.resultSchema = edges;
	}
	 ...
	 */
	public List<MyEdge> getResultSchema(){
