...
// Commented code because of the error and file is not used in discoverable period finding anyways.

public class GPCheckerFCLBJ<N, E> implements Killable{
...
//	}
	...
	private boolean populateFilter(Map<MyNode, N> assignments, Map<MyNode, Set<N>> candidates, MyNode node, Set<MyNode> confOut, Map<MyNode, Set<MyNode>> confIn){
		...
		List<MyEdge> rels = gp.getAllEdges(node);
